						...
						<div class="panel-body">
							...
							<form action="{{ url('/simpanpostingan') }}" method="post" enctype="multipart/form-data">
								...
								<div class="form-group">
									...
									<input type="text" autocomplete="off" autofocus required name="judul" class="form-control" id="judul" placeholder="Masukan Judul Postingan" onkeyup="createslug()">
								...
								<div class="form-group">
									...
									<textarea name="isipostingan" id="editor"></textarea>
								</div>
